...
// its own software-I2C pins (SCL=D33, SDA=D32). Without RFID_I2C it shares HW I2C.
  ...
  #ifdef RFID_I2C
U8G2_SSD1306_128X32_UNIVISION_F_2ND_HW_I2C u8g2(U8G2_R0, /*reset=*/ U8X8_PIN_NONE, /*SCL=*/ 33, /*SDA=*/ 32);
  #else
U8G2_SSD1306_128X32_UNIVISION_F_HW_I2C u8g2(U8G2_R0);
  #endif
#else
  #ifdef RFID_I2C
U8G2_SSD1306_128X64_NONAME_F_2ND_HW_I2C u8g2(U8G2_R0, /*reset=*/ U8X8_PIN_NONE, /*SCL=*/ 33, /*SDA=*/ 32);
  #else
